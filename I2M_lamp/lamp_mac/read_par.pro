...
'init'	: BEGIN  Status=0
  ...
  ttsymbol = [ttsymbol,'in4_904']		;exec
  ttsymbol = [ttsymbol,'in6_904']		;exec
  ...
  ttpath   = [ttpath,'/usr/illdata, \\Serdon']		;exec
  ttpath   = [ttpath,'/usr/illdata, \\Serdon']		;exec
  ttpath   = [ttpath,'/usr/illdata/xraydur, \\serdon\xraydur']		;exec
  ...
  ttpath   = [ttpath,'/usr/illdata/904/in4']		;exec
  ttpath   = [ttpath,'/usr/illdata/904/in6']		;exec
