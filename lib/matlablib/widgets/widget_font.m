...
switch fnt,
case 'ft_biggest'; fsize=15; weight='bold';
case 'ft_bigger';  fsize=13; weight='normal';
case 'ft_normal';  fsize= 9; weight='normal';
case 'ft_smaller'; fsize= 9; weight='normal';
case 'ft_smallest';fsize= 7; weight='normal';
case 'ft_b_bigger';fsize=13; weight='bold';
case 'ft_b_normal';fsize=11; weight='bold';
case 'ft_propor';  fsize=11; weight='bold';
otherwise;
end;
