...
%Unused: dynamic_resize
    ...
    I2Mkwv=    {'bise'   , 'not_r'          , 'f_get'          , 'p_set'         , 'map' , 'vol'   , 'uval'   , 'font' , 'xsize' , 'ysize' , 'scr_xs'    , 'scr_ys'    , 'sens'      , 'uname' , 'resource_name' , 'dyn'            , 'I2M_pos' };
    bise=[]; not_r=[]; f_get=[]; p_set=[]; map=[]; vol=[]; uval=[]; font=[]; xsize=[]; ysize=[]; scr_xs=[]; scr_ys=[]; sens=[]; uname=[]; resource_name=[]; dyn=[]; I2M_pos=[];
