...
case 'revers';
   ...
   %if I2Mfig(ibas,6) == 2, I2Mfig(ibas,8)=I2Mfig(ibas,8)-1; I2Mfig(ibas,7)=I2Mfig(ibas,7)+1; end;
    if I2Mfig(ibas,6) == 1, I2Mfig(ibas,8)=I2Mfig(ibas,8)  ; I2Mfig(ibas,7)=I2Mfig(ibas,7)-1; I2Mfig(ibas,9)=I2Mfig(ibas,9)+2; I2Mfig(ibas,10)=I2Mfig(ibas,10)+1; end;
otherwise;
end;
