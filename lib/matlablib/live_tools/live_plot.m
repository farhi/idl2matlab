...
I2Mkwn=char('I2M_a1' , 'I2M_a2' , 'I2M_a3' , 'I2M_a4' , 'I2M_a5' , 'I2M_a6' ,'I2M_a7' , 'I2M_a8' , 'I2M_a9' ,'buffer','dimensions','double','draw_dimensions','error','histogram',...
        'line','polar','scatter','indexed_color','instancing','location','independent','manage_style','name','no_draw','no_selection',...
        'no_status','no_toolbar','parent_base','tlb_location','preference_file','reference_out','renderer','replace','style',...
        'template_file','title','window_in','xlog','ylog','xrange','yrange','x_thickname','y_thickname','I2M_pos');
I2Mkwv=    { 'd1'   , 'd2'      ,   'd3'   ,'d4'      ,'d5'      ,'d6'      , 'd7'    ,   'd8'   ,'d9'      ,'buffer','dimensions','double','draw_dimensions','error','histogram',...
        'line','polar','scatter','indexed_color','instancing','location','independent','manage_style','name','no_draw','no_selection',...
        'no_status','no_toolbar','parent_base','tlb_location','preference_file','reference_out','renderer','replace','style',...
        'template_file','title','window_in','xlog','ylog','xrange','yrange','x_thickname','y_thickname','I2M_pos'};
...
window_in=[];xrange=[];yrange=[];x_thickname=[];y_thickname=[];
% keywords présent si =1
buffer=[];double=[];manage_style=[];no_draw=[];no_selection=[];no_status=[];no_toolbar=[];
xlog=[];ylog=[];indexed_color=[];line=[];polar=[];scatter=[];histogram=[];
...
% On cree une nouvelle figure dans laquelle on affiche live_plot
figure('Position',[176 174 452 452],'MenuBar','figure','name','Live Plot','NumberTitle','off');
