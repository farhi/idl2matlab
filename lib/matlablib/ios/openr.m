function [varargout]=openr(varargin)
%PRO openr, lun, file, get_lun=getl, append=appd, error=err, delete=del
%*** *****
%***
...
if appd; perm='at'; else perm='rt'; end;
...
if ~err,
    ...
    fst.xdr =0;   fst.compress=0; fst.read=1; fst.write=0;     fst.atime=dat;   fst.ctime=dat;  fst.mtime=dat;
