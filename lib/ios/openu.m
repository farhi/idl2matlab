function [varargout]=openu(varargin)
%PRO openu, lun, file, get_lun=getl, append=appd, error=err, delete=del
%*** *****
%***
...
if appd; perm='a+t'; else perm='r+t'; end;
...
if ~err,
    ...
    fst.xdr =0;   fst.compress=0; fst.read=1; fst.write=1;     fst.atime=dat;   fst.ctime=dat;  fst.mtime=dat;
