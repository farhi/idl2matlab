...
global  i2mvs_version i2mvs_mouse i2mvs_dir i2mvs_path i2mvs_d i2mvs_p i2mvs_x i2mvs_y i2mvs_z
...
%i2mvs_mouse  =struct('x',0,'y',0,'button',0,'time',0);
 ...
 % i2mvs_p=struct('background',a1, 'charsize',a2, 'charthick',a3, 'clip',a4, 'color',a5, 'font',a6, 'linestyle',a7, 'multi',a8, 'noclip',a9, 'noerase',a10, 'nsum',a11, 'position',a12, 'psym',a13, 'region',a14, 'subtitle',a15, 'symsize',a16, 't',a17, 't3d',a18, 'thick',a19, 'title',a20, 'ticklen',a21, 'channel',a22);
	i2mvs_p = varsysP; % initialisation de la variable systeme !P
 ...
 i2mvs_x = varsysX; % initialisation de la variable systeme !X
 ...
 i2mvs_y = varsysY; % initialisation de la variable systeme !Y
 ...
 i2mvs_z = varsysZ; % initialisation de la variable systeme !Z
 ...
 global i2mFilename % Le nom du fichier que l'on va utiliser en sortie, va etre modifie lors de l'appel a device, filename = ...
 i2mFilename = 'idl'; % Le nom de fichier par defaut
 global i2mDevPsColor; % Pour gerer l'activation ou non des couleurs dans les fichiers postscript (apres avoir fait 'set_plot,'ps' puis 'device,/color')
 i2mDevPsColor = 0;
 global i2mPsCanWrite % Une variable globale pour savoir si on va ecrire dans le fichier ps et en quel mode (normal ou append)
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FIN DE GESTION DU DEVICE POSTSCRIPT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %%%%%%%%%%% TABLE DE COULEURS %%%%%%%%%%%%%%%%%%%%
 global B_W_LINEAR % QUESTION : Est-ce qu'on declare toutes les autres ici aussi ?
