...
%***
    ...
    I2Mkwv=    {'base'   , 'not_r'          , 'eventp'    , 'eventf'     , 'f_get'          , 'p_set'         , 'map' , 'vol'   , 'uval'   , 'font' , 'xsize' , 'ysize' , 'scr_xs'    , 'scr_ys'    , 'sens'      , 'multi'    , 'uname' , 'resource_name' , 'I2M_pos' };
    base=[]; not_r=[]; eventp=[]; eventf=[]; f_get=[]; p_set=[]; map=[]; vol=[]; uval=[]; font=[]; xsize=[]; ysize=[]; scr_xs=[]; scr_ys=[]; sens=[]; multi=[]; uname=[]; resource_name=[]; I2M_pos=[];
